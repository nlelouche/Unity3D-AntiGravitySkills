...
[Test]
public void StatusEffectSystem_Should{ExpectedBehavior}_When{Condition}()
{{
    // Arrange
...
[Test]
public void StatusEffectSystem_ShouldHandle{EdgeCase}()
{{
    // Arrange
...
[Test]
public void StatusEffectSystem_ShouldThrow_When{InvalidInput}()
{{
    // Arrange
