...
description: Handles Link Traversal, Agent Configuration, and Dynamic Obstacles.
...
## Goal
Handles Link Traversal, Agent Configuration, and Dynamic Obstacles.
...
2.  **Execute Script**: Call the python script using `run_command`.
    - Command: `python .agent/skills/02-gameplay/navmesh-pathfinding/scripts/main.py --arg value`
3.  **Report**: Show the results to the user.

## Few-Shot Example
User: "Run navmesh-pathfinding..."
