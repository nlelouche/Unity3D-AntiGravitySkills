...
[Test]
public void AiCodeReviewer_Should{ExpectedBehavior}_When{Condition}()
{{
    // Arrange
...
[Test]
public void AiCodeReviewer_ShouldHandle{EdgeCase}()
{{
    // Arrange
...
[Test]
public void AiCodeReviewer_ShouldThrow_When{InvalidInput}()
{{
    // Arrange
