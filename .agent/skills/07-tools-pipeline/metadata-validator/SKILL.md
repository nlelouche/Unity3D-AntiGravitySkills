...
[Test]
public void MetadataValidator_Should{ExpectedBehavior}_When{Condition}()
{{
    // Arrange
...
[Test]
public void MetadataValidator_ShouldHandle{EdgeCase}()
{{
    // Arrange
...
[Test]
public void MetadataValidator_ShouldThrow_When{InvalidInput}()
{{
    // Arrange
...
## Related Skills` | Markdown | H2 section present |
