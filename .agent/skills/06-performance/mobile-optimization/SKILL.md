...
[Test]
public void MobileOptimization_Should{ExpectedBehavior}_When{Condition}()
{{
    // Arrange
...
[Test]
public void MobileOptimization_ShouldHandle{EdgeCase}()
{{
    // Arrange
...
[Test]
public void MobileOptimization_ShouldThrow_When{InvalidInput}()
{{
    // Arrange
