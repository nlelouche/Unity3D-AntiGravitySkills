...
[Test]
public void LodOcclusionCulling_Should{ExpectedBehavior}_When{Condition}()
{{
    // Arrange
...
[Test]
public void LodOcclusionCulling_ShouldHandle{EdgeCase}()
{{
    // Arrange
...
[Test]
public void LodOcclusionCulling_ShouldThrow_When{InvalidInput}()
{{
    // Arrange
