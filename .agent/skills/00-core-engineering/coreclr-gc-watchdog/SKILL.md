...
[Test]
public void CoreclrGcWatchdog_Should{ExpectedBehavior}_When{Condition}()
{{
    // Arrange
...
[Test]
public void CoreclrGcWatchdog_ShouldHandle{EdgeCase}()
{{
    // Arrange
...
[Test]
public void CoreclrGcWatchdog_ShouldThrow_When{InvalidInput}()
{{
    // Arrange
